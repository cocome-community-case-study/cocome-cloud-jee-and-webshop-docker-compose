...
#############################################################################
#clone newest vesion of CoCoME and Service adapter. 
#Execute clean compile, package AND install to update wsdl-files and stubs correctly
...
cd /usr/src/cocome/cocome-maven-project && mvn -s /usr/src/CoCoMEsettings.xml -T 1C clean compile package 

cd /usr/src/cocome/cocome-maven-project && mvn -s /usr/src/CoCoMEsettings.xml -T 1C package 

cd /usr/src/cocome/cocome-maven-project && mvn -s /usr/src/CoCoMEsettings.xml -T 1C install -DskipTests


cd /usr/src/serviceadapter && mvn -s /usr/src/ServiceAdaptersettings.xml -T 1C clean compile package

cd /usr/src/serviceadapter && mvn -s /usr/ServiceAdaptersettings.xml -T 1C package

cd /usr/src/serviceadapter && mvn -s /usr/src/ServiceAdaptersettings.xml -T 1C install -DskipTests
